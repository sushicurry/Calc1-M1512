...
\allowdisplaybreaks
\begin{document}
	\title{Continuity and Limits of Composite Functions}
	\date{ }
	\maketitle
	...
	Ans. No. 
	\item[2.] Determine the interval(s) on which the function
	\begin{align*}
		g(x) = \frac{3x^2 - 6x + 7}{x^2 + x + 1},
	\end{align*}
	is continuous. 
	...
	\item[3.]Evaluate $$\lim_{x \to 4} \sqrt{\frac{x^3 - 2x^2 - 8x}{x - 4}}$$
