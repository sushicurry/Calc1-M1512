...
\begin{document}
	...
	\begin{enumerate}
		\item[1.] (23 pts) Consider the function $f(x) = 8 - 2x^2$ on the interval $[0, 4]$
		\begin{enumerate}
			...
			\vspace{8cm}
			\item[d.] Using the following formula $$\sum_{k = 1}^{n} k^2 = \frac{n (2n + 1)(n + 1)}{6}$$ evaluate the definite integral $\int_{0}^{4} f(x) \; dx$ by taking the limit as $n \to \infty$ of the formula you wrote in part c. 
		\end{enumerate}
		\newpage
