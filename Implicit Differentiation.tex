...
\allowdisplaybreaks
\begin{document}
	\title{Chain Rule Practice}
	\date{ }
	\maketitle
	
	\begin{enumerate}
	\item[1.] Implicitly differentiate
	\begin{enumerate}
		\item[a.] $xy = 7$
		...
		%Ans. $5x^4 + \frac{11 x^4 \sqrt{x}}{2}$
		
		 
		%\item[c.] $ y = \left(\frac{e^{x^2}}{4x + 1}\right)^2$ 
		
		%Ans. $11 + 12 t + 3t^2$. 
	\end{enumerate}
	
	\item[2.] Find the equations of the vertical and horizontal tangent lines of the following ellipse $$x^2 + 4y^2 + 2xy = 12$$\\
